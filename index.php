...
<html>
  ...
  <body>
    ...
    <a-scene shadow="type: pcfsoft">
      ...
      <a-box
        animation-click-handler="television"
        id="television"
        class="clickable custom-animation-object"
        shadow="cast: false"
        sshadow-material=""
        ...
        animation__mouseleave="property: components.material.material.color; type: color; to: white; startEvents: mouseleave; dur: 500"
      >
        <a-image id="television-poi" rotation="0 0 0" src="#img_poi" animation-click-handler="television" alpha-test position="0 0 2" class="not-clickable"></a-image>
